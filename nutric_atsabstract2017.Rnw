...
ltmort.pred.il6.3 <- Predict(ltmort.il6.3, nutric.il6 = NA, time = 90)
ltmort.sum.il6.12 <- summary(ltmort.il6.12)
ltmort.pred.il6.12 <- Predict(ltmort.il6.12, nutric.il6 = NA, time = 355)

options(datadist = 'dd.noil6.survivors')
ltmort.sum.noil6.3 <- summary(ltmort.noil6.3)
ltmort.pred.noil6.3 <- Predict(ltmort.noil6.3, nutric.noil6 = NA, time = 90)
ltmort.sum.noil6.12 <- summary(ltmort.noil6.12)
ltmort.pred.noil6.12 <- Predict(ltmort.noil6.12, nutric.noil6 = NA, time = 355)

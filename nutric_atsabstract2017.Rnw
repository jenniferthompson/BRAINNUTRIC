...
nb.results.data <- function(test = c('adl', 'faq')){
  mod.nonutric.3 <- get(paste0(test, '.nonutric.3'))
  mod.il6.3 <- get(paste0(test, '.il6.3'))
  mod.noil6.3 <- get(paste0(test, '.noil6.3'))
  mod.nonutric.12 <- get(paste0(test, '.nonutric.12'))
  mod.il6.12 <- get(paste0(test, '.il6.12'))
  mod.noil6.12 <- get(paste0(test, '.noil6.12'))
  ...
  p.il6.3 <-
    pool.compare(mod.il6.3, mod.nonutric.3, data = mice.il6.3, method = use.method)$pvalue
  p.noil6.3 <-
    pool.compare(mod.noil6.3, mod.nonutric.3, data = mice.noil6.3, method = use.method)$pvalue
  p.il6.12 <-
    pool.compare(mod.il6.12, mod.nonutric.12, data = mice.il6.12, method = use.method)$pvalue
  p.noil6.12 <-
    pool.compare(mod.noil6.12, mod.nonutric.12, data = mice.noil6.12, method = use.method)$pvalue

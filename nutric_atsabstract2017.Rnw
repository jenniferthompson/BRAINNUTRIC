...
modeldata.il6.survivors <- brain.oneobs[brain.oneobs$cohort.survivors.il6,
                                        c(lt.covars, 'nutric.il6', 'hospdis.loc',
...
modeldata.noil6.survivors <- brain.oneobs[brain.oneobs$cohort.survivors,
                                          c(lt.covars, 'nutric.noil6', 'hospdis.loc',
                                            'days.deathlast.90', 'died.brain.90',
                                            'days.deathlast.365', 'died.brain.365')]
...
yaxis.labels <- data.frame(outcome = c('adl', 'faq', 'rbans', 'trailb', 'ltmort'),
                           ylabel = c('Katz ADL Score', 'FAQ Score', 'RBANS Global Score',
                                      'Trails B Score', 'Hazard of Death'))

## Plotting function
create.nutric.plot <- function(outcome = c('adl', 'faq', 'rbans', 'trailb', 'ltmort')){
...
this association is nonlinear, so please see Figure \ref{fig:printltmortmodels} for a full picture.
